...
const Contact = (props) => {
  return (
    <section className={style.contact}>
      ...
      <form class="form-container" data-remote="false" action="https://formspree.io/ivan93mail@gmail.com" accept-charset="UTF-8" method="post">
        ...
        <input type="submit" name="commit" value="Send" class="submit" data-disable-with="Send"/>
      </form>
    </section>
  );
};
